...
export default function EditTechnicianModal({ technician, onClose, onSuccess }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await api.patch(`users/${technician.id}/`, formData);
      onSuccess();
    } catch (err) {
      setError(err.response?.data?.error || 'Failed to update technician details.');
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="px-6 py-4 border-b border-slate-100 bg-slate-50 flex justify-between items-center shrink-0">
          <div className="flex items-center text-slate-700">
            ...
            <h3 className="font-bold text-lg">Edit Technician</h3>
          </div>
        ...
        <div className="p-6 overflow-y-auto">
          ...
          <form id="edit-technician-form" onSubmit={handleSubmit} className="space-y-4">
